<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    'action'=>$this->createUrl('/entrepreneur/default/updateaccount/', array('id' => $model->id)),
    ...
    'clientOptions' => array(
        ...
        if(!hasError) {
            $.ajax({
                "type":"POST",
                "url":"' . $this->createUrl('/entrepreneur/default/updateaccount/', array('id' => $model->id)) . '",
                "data":form.serialize(),
...
<div class="row">
    ...
    <div class="select-wrap">
        <?php echo $form->dropDownList($model,'type', $type, array('width' => '206px;', 'class' => 'drop_down_list')); ?>
    </div>
</div>
<div class="row">
